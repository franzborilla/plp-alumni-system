...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\PLP\Herd\plp-alumni-system\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\PLP\\Herd\\plp-alumni-system\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'admin.401','admin.403','alumni.401','alumni.403',
'welcome','alumni.home','alumni.news.view','alumni.events','alumni.event.view',
'alumni.jobs','alumni.job.view','alumni.submitted.jobs','admin.dashboard','alumni.management',
'alumni.view','alumni.management.destroy','alumni.management.export','forum.management','event.management',
'official.job.listings','alumni.shared.jobs','settings','settings.update.profile','settings.password',
'settings.update.password','settings.audit','settings.records','settings.downloadTemplate','settings.importCSV',
'settings.news','settings.news.save','settings.news.reset','share-job','register.education',
'register.employment','alumni-profile','career','education','post',
'view-post','find-alumni','add-post','view-profile','submitted-jobs-view',
'credentials','add-skills','job-page','job-view','employment-rate',
'further-studies','job-relevance','unemployment-period','industry-sector','geographical-distribution',
'alumni-engagement','top-hiring-companies','alumni-view','forum-view','add-event',
'event-view','official-job-listings','add-official-job','official-job-view','alumni-shared-jobs',
'shared-job-view','user-management','add-user','edit-user','alumni.login',
'home-view','register.personal','career-history','admin.admin-settings','admin.profile.update',
'alumni.destroy','admin.event-management','event.edit','event.destroy','admin.update-event',
'admin.analytics.employment-rate','admin.analytics.further-studies','admin.analytics.job-relevance','admin.analytics.unemployment','admin.analytics.geographical',
'admin.add-page.add-event','admin.add-page.add-event.store','admin.add-page.add-job','admin.add-page.add-job.store','admin.add-page.add-user',
'admin.add-page.add-user.store','admin.audit-logs','terms.privacy','admin.login','alumni.login.submit',
'admin.login.submit','password.email','password.code','password.store','register.personal.submit',
'register.education.submit','register.employment.submit','alumni.logout','admin.logout','storage.local',);
        registerArgumentsSet('views', 
'admin.login','admin.portal.alumni.alumni-management','admin.portal.alumni.alumni-view','admin.portal.dashboard.analytics.alumni-engagement','admin.portal.dashboard.analytics.employment-rate',
'admin.portal.dashboard.analytics.further-studies','admin.portal.dashboard.analytics.geographical-distribution','admin.portal.dashboard.analytics.industry-sector','admin.portal.dashboard.analytics.job-relevance','admin.portal.dashboard.analytics.unemployment-period',
'admin.portal.dashboard.dashboard','admin.portal.event.add-event','admin.portal.event.event-management','admin.portal.event.event-view','admin.portal.forum.forum-management',
'admin.portal.forum.forum-view','admin.portal.job.admin.add-official-job','admin.portal.job.admin.official-job-listings','admin.portal.job.admin.official-job-view','admin.portal.job.alumni.alumni-shared-jobs',
'admin.portal.job.alumni.shared-job-view','admin.portal.settings.add-news','admin.portal.settings.add-records','admin.portal.settings.admin-profile','admin.portal.settings.audit-logs',
'admin.portal.settings.password','admin.portal.user.add-user','admin.portal.user.edit-user','admin.portal.user.user-management','alumni.add-skills',
'alumni.login','alumni.portal.alumni-forum.add-post','alumni.portal.alumni-forum.find-alumni','alumni.portal.alumni-forum.post','alumni.portal.alumni-forum.view-post',
'alumni.portal.alumni-forum.view-profile','alumni.portal.alumni-profile','alumni.portal.education-career.career','alumni.portal.education-career.education','alumni.portal.events.event-page',
'alumni.portal.events.event-view','alumni.portal.home.home-view','alumni.portal.home.homepage','alumni.portal.jobs.job-page','alumni.portal.jobs.job-view',
'alumni.portal.submitted-jobs.share-job','alumni.portal.submitted-jobs.submitted-jobs','alumni.portal.submitted-jobs.submitted-jobs-view','alumni.registration.career-information','alumni.registration.credentials',
'alumni.registration.education-background','alumni.registration.personal-information','alumni.terms','alumni.welcome','components.action-buttons',
'components.auth-session-status','components.danger-button','components.export-button','components.filter','components.input-error',
'components.input-label','components.link-button','components.nav-link','components.otp-input','components.pagination',
'components.primary-button','components.rsvp-tag','components.secondary-button','components.select-input','components.settings-tab',
'components.skills-tag','components.tag','components.text-input','components.white-card','errors.admin-401',
'errors.admin-403','errors.alumni-401','errors.alumni-403','layouts.admin-navigation','layouts.alumni-navigation',
'layouts.app','layouts.onboard','shared.forgot-password','shared.new-password','shared.verification-code',
...
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.PLP.Herd.plp-alumni-system.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
